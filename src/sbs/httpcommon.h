...
struct HttpData {
  ...
  HttpVersion version;
  std::unique_ptr<rtc::StreamInterface> document;
  ...
  void setContent(const std::string& content_type, rtc::StreamInterface* document);
  void setDocumentAndLength(rtc::StreamInterface* document);
